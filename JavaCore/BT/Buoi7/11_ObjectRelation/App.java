...
public class App {
  public static void main(String[] args) {
    ...
    list1.add(new LineItem(arisPro, 1000, 1));
    list1.add(new LineItem(maiWei, 2000, 1));
    list1.add(new LineItem(maiWei, 3000, 2));

    List<LineItem> list2 = new ArrayList<LineItem>();
    list2.add(new LineItem(supHyper, 1000, 2));
    list2.add(new LineItem(maiWei, 2000, 2));
    list2.add(new LineItem(maiWei, 3000, 2));

    List<LineItem> list3 = new ArrayList<LineItem>();
    list3.add(new LineItem(arisPro, 1000, 3));
    list3.add(new LineItem(supHyper, 2000, 3));
    list3.add(new LineItem(arisPro, 3000, 3));

    //Order có nhiều Line Item
    List<LineItem> list4 = new ArrayList<LineItem>();
    list4.add(new LineItem(supHyper, 1000, 3));
    list4.add(new LineItem(supHyper, 2000, 3));
    list4.add(new LineItem(supHyper, 3000, 3));
    list4.add(new LineItem(arisPro, 3000, 3));
    list4.add(new LineItem(maiWei, 2000, 2));
    list4.add(new LineItem(maiWei, 3000, 2));
    list4.add(new LineItem(arisPro, 1000, 3));



    // Khởi tạo đơn hàng
    //Tom đặt nhiều đơn hàng
    Order order1 = new Order(tom, LocalDateTime.now(), "oder1", list1);
    Order order4 = new Order(tom, LocalDateTime.now(), "oder4", list4);
