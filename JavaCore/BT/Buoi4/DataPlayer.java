...
public class DataPlayer {
    public static Team manUtd() {
        ...
        teamManUtd.setListPlayers(Arrays.asList(players));
        return teamManUtd;
    }
    ...
    public static Team bayern() {
        ...
        teamBayern.setListPlayers(Arrays.asList(players));
        return teamBayern;
    }
    ...
    public static Team real() {
        ...
        teamReal.setListPlayers(Arrays.asList(players));
        return teamReal;
    }
    ...
    public static Team liverpool() {
        ...
        teamLiverpool.setListPlayers(Arrays.asList(players));
        return teamLiverpool;
    }
    ...
    public static Team barca() {
        ...
        teamBarca.setListPlayers(Arrays.asList(players));
        return teamBarca;
    }
}
