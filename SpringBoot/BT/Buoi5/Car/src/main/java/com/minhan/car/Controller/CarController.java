...
public class CarController {
    ...
    @PostMapping("/add")
    public String add(@Valid @ModelAttribute Car car, BindingResult bindingResult, Model model) {
    ...
    @PostMapping("/search")
    public String search(@Valid @ModelAttribute StringRequest stringRequest, BindingResult bindingResult, Model model) {
        if (!bindingResult.hasErrors()) {
    ...
    public String edit(@Valid @ModelAttribute Car car, BindingResult bindingResult, Model model) {
        if (!bindingResult.hasErrors()) {
            cars.edit(car);
            return getAll(model);
        }
